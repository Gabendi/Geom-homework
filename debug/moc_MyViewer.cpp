...
QT_MOC_LITERAL(1, 9, 16), // "startComputation"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 7), // "message"
QT_MOC_LITERAL(4, 35, 14), // "midComputation"
QT_MOC_LITERAL(5, 50, 7), // "percent"
QT_MOC_LITERAL(6, 58, 14) // "endComputation"
...
void MyViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MyViewer::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyViewer::startComputation)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyViewer::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyViewer::midComputation)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MyViewer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyViewer::endComputation)) {
                *result = 2;
                return;
            }
        }
